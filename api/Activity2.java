...
public class Activity2 {
  ...
  public void PostReq () throws IOException{
      ...
      //FileInputStream inputJSON= new FileInputStream("src/test/java/activities/Activity3.json");
      String reqBody= new String(Files.readAllBytes(Paths.get("src/test/java/activities/Activity2.json")));
